...
class DispatchController extends Controller
{
    ...
    public function create(Request $req)
    {
        ...
        return view('admin.dispatches.create', compact(
            'warehouses','routes','drivers','orders','clientesConSaldo'
        ));
    }
    ...
    public function store(Request $request)
    {
        ...
        return DB::transaction(function () use ($data) {
            ...
            // Asignar clientes con CxC pendiente
            if (!empty($data['clientes_ar'])) {
                // Calcular saldo actual por cliente
    ...
    public function enRuta(Dispatch $dispatch)
    {
        ...
        return back()->with('swal', ['icon'=>'success','title'=>'En ruta','text'=>'Despacho y pedidos enviados a ruta.']);
    }
    ...
    /**
     * Cobrar una CxC asignada al despacho — abono directo al saldo del cliente.
     */
