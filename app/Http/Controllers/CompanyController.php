...
use App\Http\Requests\SaveCompanyCertificateRequest;
use App\Http\Requests\SaveCompanyFiscalDataRequest;
...
class CompanyController extends Controller
{
    ...
    public function store(SaveCompanyRequest $request): RedirectResponse
    {
        ...
        // Asociar al usuario autenticado como admin
    ...
    {
        $fiscalData = $company->fiscalData ?? new CompanyFiscalData(['company_id' => $company->id]);
    ...
    public function fiscalUpdate(SaveCompanyFiscalDataRequest $request, Company $company): RedirectResponse
    {
        ...
        return redirect()
            ...
            ->with('success', 'Datos fiscales guardados. Ahora sube los certificados digitales.');
    }
    ...
    public function certificateStore(SaveCompanyCertificateRequest $request, Company $company): RedirectResponse
    {
        DB::transaction(function () use ($request, $company) {
            ...
            // Guardar archivos en storage/app/private (nunca en public)
            ...
            // Desactivar certificados previos del mismo tipo
            ...
            // Leer y guardar metadatos del .cer
    ...
    {
        // El observer del modelo eliminará los archivos físicos
        $certificate->delete();
