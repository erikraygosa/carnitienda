...
class CompanyService
{
    ...
    public function activa(): ?Company
    {
        ...
        return Cache::remember("company_activa_{$userId}", 60, function () use ($userId) {
            ...
            $company = Company::whereHas('users', function ($q) use ($userId) {
            ...
            // 3) Fallback final: primera empresa del sistema (útil en instalación inicial)
            return Company::where('activo', true)->first();
        });
    }
