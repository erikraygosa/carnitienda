...
Route::get ('clients/price-history',     [ClientController::class, 'priceHistory'])->name('clients.price-history')->middleware('can:ver clientes');
...
Route::post('sales-orders/quick', [SalesOrderController::class, 'quickStore'])->name('sales-orders.quick-store');
...
Route::post('dispatches/{dispatch}/pedidos/quitar-bulk',        [DispatchController::class,'quitarPedidosBulk'])->name('dispatches.pedidos.quitar-bulk');
