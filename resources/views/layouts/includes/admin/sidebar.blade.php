...
$links = [
  ...
  ['name'=>'Catálogo','icon'=>'fa-solid fa-database','can'=>$user->hasAnyPermission(['ver productos','ver clientes','ver proveedores']),'active'=>request()->routeIs('admin.categories.*')||request()->routeIs('admin.products.*')||request()->routeIs('admin.clients.*')||request()->routeIs('admin.providers.*')||request()->routeIs('admin.shipping-routes.*'),'children'=>[['name'=>'Categorias','icon'=>'fa-solid fa-list','href'=>route('admin.categories.index'),'active'=>request()->routeIs('admin.categories.*'),'can'=>$user->hasPermissionTo('ver productos')],['name'=>'Productos','icon'=>'fa-solid fa-box-open','href'=>route('admin.products.index'),'active'=>request()->routeIs('admin.products.*'),'can'=>$user->hasPermissionTo('ver productos')],['name'=>'Clientes','icon'=>'fa-solid fa-users','href'=>route('admin.clients.index'),'active'=>request()->routeIs('admin.clients.*'),'can'=>$user->hasPermissionTo('ver clientes')],['name'=>'Proveedores','icon'=>'fa-solid fa-truck','href'=>route('admin.providers.index'),'active'=>request()->routeIs('admin.providers.*'),'can'=>$user->hasPermissionTo('ver proveedores')],['name'=>'Rutas de entrega','icon'=>'fa-solid fa-route','href'=>route('admin.shipping-routes.index'),'active'=>request()->routeIs('admin.shipping-routes.*'),'can'=>$user->hasPermissionTo('ver configuracion')]]],
  ['header'=>'Compras','can'=>$user->hasPermissionTo('ver compras')],
  ['name'=>'Compras','icon'=>'fa-solid fa-cart-shopping','can'=>$user->hasPermissionTo('ver compras'),'active'=>request()->routeIs('admin.purchase-orders.*')||request()->routeIs('admin.purchases.*'),'children'=>[['name'=>'Órdenes de compra','icon'=>'fa-solid fa-cart-plus','href'=>route('admin.purchase-orders.index'),'active'=>request()->routeIs('admin.purchase-orders.*'),'can'=>$user->hasPermissionTo('ver ordenes de compra')],['name'=>'Compras','icon'=>'fa-solid fa-cart-shopping','href'=>route('admin.purchases.index'),'active'=>request()->routeIs('admin.purchases.*'),'can'=>$user->hasPermissionTo('ver compras')]]],
  ['header'=>'Inventario','can'=>$user->hasAnyPermission(['ver stock','ver precios almacen'])],
  ['name'=>'Inventario','icon'=>'fa-solid fa-warehouse','can'=>$user->hasAnyPermission(['ver stock','ver precios almacen']),'active'=>request()->routeIs('admin.warehouses.*')||request()->routeIs('admin.stock.*')||request()->routeIs('admin.precios.*'),'children'=>[['name'=>'Almacenes','icon'=>'fa-solid fa-warehouse','href'=>route('admin.warehouses.index'),'active'=>request()->routeIs('admin.warehouses.*'),'can'=>$user->hasPermissionTo('gestionar almacenes')],['name'=>'Stock','icon'=>'fa-solid fa-layer-group','href'=>route('admin.stock.index'),'active'=>request()->routeIs('admin.stock.index'),'can'=>$user->hasPermissionTo('ver stock')],['name'=>'Traspasos','icon'=>'fa-solid fa-right-left','href'=>route('admin.stock.transfers.index'),'active'=>request()->routeIs('admin.stock.transfers.*'),'can'=>$user->hasPermissionTo('gestionar traspasos')],['name'=>'Precios por almacén','icon'=>'fa-solid fa-tags','href'=>route('admin.precios.index'),'active'=>request()->routeIs('admin.precios.*'),'can'=>$user->hasPermissionTo('ver precios almacen')]]],
  ['header'=>'Ventas','can'=>$user->hasPermissionTo('ver pedidos')],
  ['name'=>'Ventas','icon'=>'fa-solid fa-file-invoice-dollar','can'=>$user->hasPermissionTo('ver pedidos'),'active'=>request()->routeIs('admin.quotes.*')||request()->routeIs('admin.sales-orders.*')||request()->routeIs('admin.sales.*'),'children'=>[['name'=>'Cotizaciones','icon'=>'fa-solid fa-file-invoice-dollar','href'=>route('admin.quotes.index'),'active'=>request()->routeIs('admin.quotes.*'),'can'=>$user->hasPermissionTo('ver cotizaciones')],['name'=>'Pedidos','icon'=>'fa-solid fa-file-invoice','href'=>route('admin.sales-orders.index'),'active'=>request()->routeIs('admin.sales-orders.*'),'can'=>$user->hasPermissionTo('ver pedidos')],['name'=>'Notas de venta','icon'=>'fa-solid fa-receipt','href'=>route('admin.sales.index'),'active'=>request()->routeIs('admin.sales.*'),'can'=>$user->hasPermissionTo('ver pedidos')]]],
  ['header'=>'Facturación','can'=>$user->hasAnyPermission(['ver facturas','generar complementos pago','ver notas credito'])],
  ['name'=>'Facturación','icon'=>'fa-solid fa-file-invoice','can'=>$user->hasAnyPermission(['ver facturas','generar complementos pago','ver notas credito','facturar varios pedidos']),'active'=>request()->routeIs('admin.invoices.*')||request()->routeIs('admin.ar.complementos.*')||request()->routeIs('admin.notas-credito.*'),'children'=>[['name'=>'Facturas','icon'=>'fa-solid fa-file-invoice','href'=>route('admin.invoices.index'),'active'=>request()->routeIs('admin.invoices.*'),'can'=>$user->hasPermissionTo('ver facturas')],['name'=>'Emitir factura','icon'=>'fa-solid fa-file-circle-plus','href'=>route('admin.invoices.create'),'active'=>request()->routeIs('admin.invoices.create'),'can'=>$user->hasPermissionTo('crear facturas')],['name'=>'Facturar varios pedidos','icon'=>'fa-solid fa-layer-group','href'=>route('admin.invoices.consolidada'),'active'=>request()->routeIs('admin.invoices.consolidada*'),'can'=>$user->hasPermissionTo('facturar varios pedidos')],['name'=>'Complementos de Pago','icon'=>'fa-solid fa-file-circle-check','href'=>route('admin.ar.complementos.index'),'active'=>request()->routeIs('admin.ar.complementos.*'),'can'=>$user->hasPermissionTo('generar complementos pago')],['name'=>'Notas de Crédito','icon'=>'fa-solid fa-file-circle-minus','href'=>route('admin.notas-credito.index'),'active'=>request()->routeIs('admin.notas-credito.*'),'can'=>$user->hasPermissionTo('ver notas credito')]]],
  ...
  ['name'=>'Despacho','icon'=>'fa-solid fa-truck-fast','can'=>$user->hasPermissionTo('ver despachos'),'active'=>request()->routeIs('admin.dispatches.*')||request()->routeIs('admin.driver-cash.*')||request()->routeIs('admin.drivers.*'),'children'=>[['name'=>'Despachos','icon'=>'fa-solid fa-route','href'=>route('admin.dispatches.index'),'active'=>request()->routeIs('admin.dispatches.*'),'can'=>$user->hasPermissionTo('ver despachos')],['name'=>'Choferes','icon'=>'fa-solid fa-id-card','href'=>route('admin.drivers.index'),'active'=>request()->routeIs('admin.drivers.*'),'can'=>$user->hasPermissionTo('ver configuracion')],['name'=>'Cortes de choferes','icon'=>'fa-solid fa-cash-register','href'=>route('admin.driver-cash.index'),'active'=>request()->routeIs('admin.driver-cash.*'),'can'=>$user->hasPermissionTo('ver despachos')]]],
  ...
  ['name'=>'Cuentas y cobros','icon'=>'fa-solid fa-piggy-bank','can'=>$user->hasPermissionTo('ver cxc'),'active'=>request()->routeIs('admin.ar.index')||request()->routeIs('admin.ar-payments.*'),'children'=>[['name'=>'Cuentas','icon'=>'fa-solid fa-file-invoice-dollar','href'=>route('admin.ar.index'),'active'=>request()->routeIs('admin.ar.index'),'can'=>$user->hasPermissionTo('ver cxc')],['name'=>'Cobros','icon'=>'fa-solid fa-cash-register','href'=>route('admin.ar-payments.create'),'active'=>request()->routeIs('admin.ar-payments.create'),'can'=>$user->hasPermissionTo('registrar cobros')],['name'=>'Notas pendientes de cobro','icon'=>'fa-solid fa-file-invoice-dollar','href'=>route('admin.ar-payments.notas.index'),'active'=>request()->routeIs('admin.ar-payments.notas.index'),'can'=>$user->hasPermissionTo('ver cxc')]]],
  ...
  ['header'=>'Sistema','can'=>$user->hasAnyPermission(['ver auditoria','gestionar notas todas sucursales'])],
  ['name'=>'Gestión de notas','icon'=>'fa-solid fa-file-pen','href'=>route('admin.gestion-notas.index'),'active'=>request()->routeIs('admin.gestion-notas.*'),'can'=>$user->hasPermissionTo('gestionar notas todas sucursales')],
