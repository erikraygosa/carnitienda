    ...
    <x-wire-card>
        ...
        <div class="flex flex-wrap gap-3 mb-4">
            <input id="filter-search" type="text"
                placeholder="Buscar código / nombre / dirección..."
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700 text-sm">
                ...
                <tbody id="warehouse-tbody" class="divide-y divide-gray-200 dark:divide-gray-700">
                    @foreach($warehouses as $warehouse)
                    <tr
                        data-search="{{ strtolower($warehouse->codigo . ' ' . $warehouse->nombre . ' ' . $warehouse->direccion) }}"
                        data-activo="{{ $warehouse->activo ? '1' : '0' }}"
                    >
    ...
    (function () {
        ...
        function renderPage() {
            ...
            paginationInfo.textContent = total > 0
                ? `Mostrando ${start + 1}–${Math.min(end, total)} de ${total} almacenes`
                : '';
