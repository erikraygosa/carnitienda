...
>
        ...
        <form id="inv-form"
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div class="md:col-span-2 space-y-1">
                    ...
                    <div id="client-meta" class="text-xs text-gray-500 flex gap-3 pt-1" style="display:none!important">
    ...
    // Actualiza los inputs de una fila con los valores actuales de items[i]
