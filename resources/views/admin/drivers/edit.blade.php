    ...
    <x-wire-card class="max-w-lg">
        <form method="POST" action="{{ route('admin.drivers.update', $driver) }}" class="space-y-4">
            ...
            <div>
                ...
                <input type="text" name="nombre" value="{{ old('nombre', $driver->nombre) }}" required autofocus
            ...
            <div>
                ...
                <input type="text" name="telefono" value="{{ old('telefono', $driver->telefono) }}"
                       class="w-full rounded-md border-gray-300 shadow-sm text-sm focus:border-indigo-500 focus:ring-indigo-500"
            ...
            <div>
                ...
                <input type="text" name="licencia" value="{{ old('licencia', $driver->licencia) }}"
            ...
            <div class="flex items-center gap-2">
                ...
                <input type="checkbox" name="activo" id="activo" value="1"
                       ...
                       {{ old('activo', $driver->activo) ? 'checked' : '' }}>
            ...
            <div class="flex items-center gap-3 pt-2">
                ...
                <span class="text-xs text-gray-400">{{ $driver->dispatches_count }} despacho(s) asignado(s)</span>
            </div>
        </form>
    </x-wire-card>
</x-admin-layout>
